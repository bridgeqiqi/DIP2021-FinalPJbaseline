...
def main(image_root_path, image_gt_path, image_save_path, image_gt_save_path):
    ...
    for imagename in images:
        ...
        gtpath = os.path.join(image_gt_path, imagename).replace('.jpg','_ann.mat')
...
if __name__ == '__main__':
    image_root_path = '/mnt/pami23/jqgao/UCF-QNRF_ECCV18/Train'
    image_gt_path = '/mnt/pami23/jqgao/UCF-QNRF_ECCV18/Train'
    image_save_path = '/mnt/pami23/jqgao/CrowdCountingDatasets/UCFQNRF/fullresolution/origin/Train/'
    image_gt_save_path = '/mnt/pami23/jqgao/CrowdCountingDatasets/UCFQNRF/fullresolution/origin/Train_gt'

    main(image_root_path, image_gt_path, image_save_path, image_gt_save_path)

    image_root_path = '/mnt/pami23/jqgao/UCF-QNRF_ECCV18/Test'
    image_gt_path = '/mnt/pami23/jqgao/UCF-QNRF_ECCV18/Test'
    image_save_path = '/mnt/pami23/jqgao/CrowdCountingDatasets/UCFQNRF/fullresolution/origin/Test/'
    image_gt_save_path = '/mnt/pami23/jqgao/CrowdCountingDatasets/UCFQNRF/fullresolution/origin/Test_gt'
